...
jQuery.extend(jQuery.easing, {
    ...
    easeInOutBack: function(t, e, n, i, a, r) {
        return null == r && (r = 1.70158),
        (e /= a / 2) < 1 ? i / 2 * (e * e * ((1 + (r *= 1.525)) * e - r)) + n : i / 2 * ((e -= 2) * e * ((1 + (r *= 1.525)) * e + r) + 2) + n
    },
        ...
        n.extend = function() {
            ...
            l--); u > l; l++)
                if (null != (r = arguments[l]))
                    for (a in r)
                        t = s[a],
                        s !== (i = r[a]) && (c && i && (n.isPlainObject(i) || (e = n.isArray(i))) ? (e ? (e = !1,
                        o = t && n.isArray(t) ? t : []) : o = t && n.isPlainObject(t) ? t : {},
                        s[a] = n.extend(c, o, i)) : void 0 !== i && (s[a] = i));
            return s
        }
        ,
    ...
    return function(t, e, n, i) {
        ...
        function o(t, n, i, a) {
            ...
            var w = y ? new Float32Array(v) : new Array(v)
              ...
              , C = function(e) {
                return k || h(),
                t === n && i === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(function(e) {
                    for (var n = 0, a = 1, r = v - 1; a != r && w[a] <= e; ++a)
                        n += b;
                    ...
                    if (v.State.calls[a]) {
                        ...
                        for (var m = Math.min((e - h) / d.duration, 1), b = 0, x = s.length; x > b; b++) {
                            ...
                            if (r(C)) {
                                ...
                                for (var M in d.visibility !== i && "hidden" !== d.visibility && y.setPropertyValue(C, "visibility", d.visibility),
                                k)
                                    if ("element" !== M) {
                                        ...
                                        "tween" === M)
                                            ...
                                            y.Hooks.registered[M] && (r(C).rootPropertyValueCache[_] = y.Normalizations.registered[_] ? y.Normalizations.registered[_]("extract", null, F[1]) : F[1]),
                                            "transform" === F[0] && (S = !0)
                                        }
                                    }
                        ...
                        d.display !== i && "none" !== d.display && (v.State.calls[a][2].display = !1),
                        d.visibility !== i && "hidden" !== d.visibility && (v.State.calls[a][2].visibility = !1),
                        d.progress && d.progress.call(o[1], o[1], m, Math.max(0, h + d.duration - e), h, g),
                        1 === m && u(a)
                    }
            }
        ...
        function u(t, e) {
            ...
            for (var n = v.State.calls[t][0], a = v.State.calls[t][1], o = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, u = 0, d = n.length; d > u; u++) {
                ...
                !0 !== o.loop && (c.queue(h)[1] === i || !/\.velocityQueueEntryFlag/i.test(c.queue(h)[1])) && r(h)) {
                    r(h).isAnimating = !1,
                    ...
                    c.each(y.Lists.transforms3D, function(t, e) {
                        ...
                        r(h).transformCache[e] !== i && new RegExp("^\\(" + n + "[^.]").test(a) && (f = !0,
                ...
                s && !0 !== o.loop && s(a),
                r(h) && !0 === o.loop && !e && (c.each(r(h).tweensContainer, function(t, e) {
        ...
        if (t.fn && t.fn.jquery ? (c = t,
        p = !0) : c = e.Velocity.Utilities,
        8 >= d && !p)
        ...
        if (!(7 >= d)) {
            ...
            var b = function() {
                ...
                return function t(e, i, a) {
                    ...
                    l.tension = e,
                    l.friction = i,
                    (r = null !== a) ? o = (c = t(e, i)) / a * .016 : o = .016; s = n(s || l, o),
                    u.push(1 + s.x),
                    c += 16,
            ...
            var y = v.CSS = {
                ...
                Hooks: {
                    ...
                    injectValue: function(t, e, n) {
                        ...
                        if (i) {
                            var a, r = i[0], o = i[1];
                            return (a = (n = y.Hooks.cleanRootPropertyValue(r, n)).toString().match(y.RegEx.valueSplit))[o] = e,
                            a.join(" ")
                        }
                        return n
                    }
                ...
                Normalizations: {
                    registered: {
                        clip: function(t, e, n) {
                            ...
                            case "extract":
                                var i;
                                return y.RegEx.wrappedValueAlreadyExtracted.test(n) ? i = n : i = (i = n.toString().match(y.RegEx.valueUnwrap)) ? i[1].replace(/,(\s+)?/g, " ") : n,
                                i;
                            case "inject":
                                return "rect(" + n + ")"
                            }
                            ...
                            !function() {
                                ...
                                y.Normalizations.registered[e] = function(t, n, a) {
                                    ...
                                    case "inject":
                                        ...
                                        case "scal":
                                        case "scale":
                                            v.State.isAndroid && r(n).transformCache[e] === i && 1 > a && (a = 1),
                                            o = !/(\d)$/i.test(a);
                                            break;
                                        case "skew":
                                            o = !/(deg|\d)$/i.test(a);
                                        ...
                                        return o || (r(n).transformCache[e] = "(" + a + ")"),
                                ...
                                y.Normalizations.registered[e] = function(t, n, a) {
                                    ...
                                    case "extract":
                                        ...
                                        if (y.RegEx.wrappedValueAlreadyExtracted.test(a))
                                            ...
                                            /^[A-z]+$/i.test(a) ? o = s[a] !== i ? s[a] : s.black : y.RegEx.isHex.test(a) ? o = "rgb(" + y.Values.hexToRgb(a).join(" ") + ")" : /^rgba?\(/i.test(a) || (o = s.black),
                                            r = (o || a).toString().match(y.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                                        return 8 >= d || 3 !== r.split(" ").length || (r += " 1"),
                                        r;
                                    case "inject":
                                        return 8 >= d ? 4 === a.split(" ").length && (a = a.split(/\s+/).slice(0, 3).join(" ")) : 3 === a.split(" ").length && (a += " 1"),
                ...
                getPropertyValue: function(t, n, a, o) {
                    function s(t, n) {
                        ...
                        if (8 >= d)
                            ...
                            var u, h = !1;
                            if (/^(width|height)$/.test(n) && 0 === y.getPropertyValue(t, "display") && (h = !0,
                            ...
                            ("" === (l = 9 === d && "filter" === n ? u.getPropertyValue(n) : u[n]) || null === l) && (l = t.style[n]),
                            a()
                        }
                    ...
                    if (y.Hooks.registered[n]) {
                        var u = n
                          , h = y.Hooks.getRoot(u);
                        a === i && (a = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])),
                        y.Normalizations.registered[h] && (a = y.Normalizations.registered[h]("extract", t, a)),
                        l = y.Hooks.extractValue(u, a)
                    } else if (y.Normalizations.registered[n]) {
                        var f, p;
                        "transform" !== (f = y.Normalizations.registered[n]("name", t)) && (p = s(t, y.Names.prefixCheck(f)[0]),
                ...
                setPropertyValue: function(t, n, i, a, o) {
                    ...
                    if ("scroll" === n)
                    ...
                    else if (y.Normalizations.registered[n] && "transform" === y.Normalizations.registered[n]("name", t))
                        ...
                        if (y.Normalizations.registered[n] && (i = y.Normalizations.registered[n]("inject", t, i),
                        ...
                        8 >= d)
                            ...
                            r(t) && r(t).isSVG && y.Names.SVGAttribute(n) ? t.setAttribute(n, i) : t.style[s] = i;
            ...
            var x = function() {
                ...
                function o() {
                    function t(t) {
                        ...
                        function g() {
                            ...
                            if (a && i)
                                ...
                                c.each(["overflow", "overflowX", "overflowY"], function(t, e) {
                                ...
                                c.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function(t, e) {
                        ...
                        if ("scroll" === P) {
                            ...
                            M = (x = u.container["scroll" + A]) + c(o).position()[A.toLowerCase()] + I) : u.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + A]],
                            ...
                            for (var D in _)
                                if ("element" !== D) {
                                    ...
                                    v.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(_[D]), o)
                                }
                            d = _
                        } else if ("start" === P) {
                            ...
                            b) {
                                ...
                                if (r(o).isSVG || "tween" === W || !1 !== y.Names.prefixCheck(W)[1] || y.Normalizations.registered[W] !== i) {
                                    (u.display !== i && null !== u.display && "none" !== u.display || u.visibility !== i && "hidden" !== u.visibility) && /opacity|filter/.test(O) && !E && 0 !== z && (E = 0),
                                    u._cacheValues && _ && _[O] ? (E === i && (E = _[O].endValue + _[O].unitType),
                                    B = r(o).rootPropertyValueCache[W]) : y.Hooks.registered[O] ? E === i ? (B = y.getPropertyValue(o, W),
                                    E = y.getPropertyValue(o, O, B)) : B = y.Hooks.templates[W][1] : E === i && (E = y.getPropertyValue(o, O));
                                    var H, j, q, Y = !1;
                                    if (E = (H = p(O, E))[0],
                                    q = H[1],
                        ...
                        d.element && (y.Values.addClass(o, "velocity-animating"),
                        R.push(d),
                        "" === u.queue && (r(o).tweensContainer = d,
                        r(o).opts = u),
                        r(o).isAnimating = !0,
                        S === C - 1 ? (v.State.calls.push([R, m, u, null, T.resolver]),
                        !1 === v.State.isTicking && (v.State.isTicking = !0,
                        l())) : S++)
                    }
                    var a, o = this, u = c.extend({}, v.defaults, w), d = {};
                    switch (r(o) === i && v.init(o),
                    parseFloat(u.delay) && !1 !== u.queue && c.queue(o, u.queue, function(t) {
                    ...
                    !1 !== v.mock && (!0 === v.mock ? u.duration = u.delay = 1 : (u.duration *= parseFloat(v.mock) || 1,
                    ...
                    u.display !== i && null !== u.display && (u.display = u.display.toString().toLowerCase(),
                    "auto" === u.display && (u.display = v.CSS.Values.getDisplayType(o))),
                    u.visibility !== i && null !== u.visibility && (u.visibility = u.visibility.toString().toLowerCase()),
                    u.mobileHA = u.mobileHA && v.State.isMobile && !v.State.isGingerbread,
                    !1 === u.queue ? u.delay ? setTimeout(t, u.delay) : t() : c.queue(o, u.queue, function(e, n) {
                        return !0 === n ? (T.promise && T.resolver(m),
                        ...
                        return c.each(v.State.calls, function(t, e) {
                            e && c.each(e[1], function(n, a) {
                                ...
                                return !0 !== o && e[2].queue !== o && (w !== i || !1 !== e[2].queue) || void c.each(m, function(n, i) {
                                    ...
                                    "stop" === b ? (r(i) && r(i).tweensContainer && !1 !== o && c.each(r(i).tweensContainer, function(t, e) {
                        ...
                        if (!c.isPlainObject(b) || f.isEmptyObject(b)) {
                            if (f.isString(b) && v.Redirects[b]) {
                                var I = (O = c.extend({}, w)).duration
                                  , _ = O.delay || 0;
                                return !0 === O.backwards && (m = c.extend(!0, [], m).reverse()),
                                c.each(m, function(t, e) {
                                    parseFloat(O.stagger) ? O.delay = _ + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = _ + O.stagger.call(e, t, C)),
            ...
            c.each(["Down", "Up"], function(t, e) {
                v.Redirects["slide" + e] = function(t, n, a, r, o, s) {
                    var l = c.extend({}, n)
                      ...
                      , f = {};
                    l.display === i && (l.display = "Down" === e ? "inline" === v.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"),
                    l.begin = function() {
                        for (var n in u && u.call(o, o),
                        h) {
                            f[n] = t.style[n];
    ...
    return function() {
        ...
        4: [function(t, e, n) {
            ...
            function c(t) {
                ...
                [116 * (i = i > .008856 ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16, 500 * (n - i), 200 * (i - (a = a > .008856 ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116))]
            }
            function d(t) {
            ...
            function y(t) {
                ...
                return r <= 8 ? a = (n = 100 * r / 903.3) / 100 * 7.787 + 16 / 116 : (n = 100 * Math.pow((r + 16) / 116, 3),
        ...
        15: [function(t, e, n) {
            ...
            e.exports = function(t) {
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    getRuler: function() {
                        var t, e, n = this.getIndexScale(), i = this.getStackCount(), a = this.index, o = n.isHorizontal(), s = o ? n.left : n.top, l = s + (o ? n.width : n.height), u = [];
                        for (t = 0,
                    ...
                    calculateBarValuePixels: function(t, e) {
                        var n, i, a, r, o, s, l = this.chart, u = this.getMeta(), c = this.getValueScale(), d = l.data.datasets, h = c.getRightValue(d[t].data[e]), f = c.options.stacked, p = u.stack, g = 0;
                        if (f || void 0 === f && void 0 !== p)
                            for (n = 0; n < t; ++n)
                                (i = l.getDatasetMeta(n)).bar && i.stack === p && i.controller.getValueScaleId() === c.id && l.isDatasetVisible(n) && (a = c.getRightValue(d[n].data[e]),
                                (h < 0 && a < 0 || h >= 0 && a > 0) && (g += a));
                    ...
                    calculateBarIndexPixels: function(t, e, n) {
                        var i = n.scale.options
                          , a = "flex" === i.barThickness ? function(t, e, n) {
                            ...
                            return r.isNullOrUndef(o) ? (i = e.min * n.categoryPercentage,
                            a = n.barPercentage) : (i = o * s,
                            a = 1),
                            {
                                chunk: i / s,
                                ratio: a,
            ...
            e.exports = function(t) {
                t.controllers.bubble = t.DatasetController.extend({
                    ...
                    setHoverStyle: function(t) {
                        ...
                        e.backgroundColor = r.valueOrDefault(n.hoverBackgroundColor, r.getHoverColor(n.backgroundColor)),
                        e.borderColor = r.valueOrDefault(n.hoverBorderColor, r.getHoverColor(n.borderColor)),
                        e.borderWidth = r.valueOrDefault(n.hoverBorderWidth, n.borderWidth),
                        e.radius = n.radius + n.hoverRadius
                    },
                    _resolveElementOptions: function(t, e) {
                        var n, i, a, o = this.chart, s = o.data.datasets[this.index], l = t.custom || {}, u = o.options.elements.point, c = r.options.resolve, d = s.data[e], h = {}, f = {
                            chart: o,
                            dataIndex: e,
                            dataset: s,
                        ...
                        return h.radius = c([l.radius, d ? d.r : void 0, s.radius, u.radius], f, e),
                        h
                    }
                })
            }
            ...
            e.exports = function(t) {
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    updateElement: function(t, e, n) {
                        ...
                        b.backgroundColor = y.backgroundColor ? y.backgroundColor : x(f.backgroundColor, e, w.backgroundColor),
                        b.borderColor = y.borderColor ? y.borderColor : x(f.borderColor, e, w.borderColor),
                        b.borderWidth = y.borderWidth ? y.borderWidth : x(f.borderWidth, e, w.borderWidth),
                        n && l.animateRotate || (b.startAngle = 0 === e ? s.rotation : i.getMeta().data[e - 1]._model.endAngle,
                    ...
                    getMaxBorderWidth: function(t) {
                        for (var e, n, i = 0, a = this.index, r = t.length, o = 0; o < r; o++)
                            ...
                            i = (n = t[o]._chart ? t[o]._chart.config.data.datasets[a].hoverBorderWidth : 0) > (i = e > i ? e : i) ? n : i;
                        return i
                    }
                })
            }
        ...
        18: [function(t, e, n) {
            ...
            e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    dataElementType: a.Point,
                    update: function(t) {
                        var n, i, a, o = this, s = o.getMeta(), l = s.dataset, u = s.data || [], c = o.chart.options, d = c.elements.line, h = o.getScaleForId(s.yAxisID), f = o.getDataset(), p = e(f, c);
                        for (p && (a = l.custom || {},
                    ...
                    getPointBackgroundColor: function(t, e) {
                        var n = this.chart.options.elements.point.backgroundColor
                          , i = this.getDataset()
                          , a = t.custom || {};
                        return a.backgroundColor ? n = a.backgroundColor : i.pointBackgroundColor ? n = r.valueAtIndexOrDefault(i.pointBackgroundColor, e, n) : i.backgroundColor && (n = i.backgroundColor),
                        n
                    },
                    getPointBorderColor: function(t, e) {
                        var n = this.chart.options.elements.point.borderColor
                          , i = this.getDataset()
                          , a = t.custom || {};
                        return a.borderColor ? n = a.borderColor : i.pointBorderColor ? n = r.valueAtIndexOrDefault(i.pointBorderColor, e, n) : i.borderColor && (n = i.borderColor),
                        n
                    },
                    getPointBorderWidth: function(t, e) {
                        var n = this.chart.options.elements.point.borderWidth
                          , i = this.getDataset()
                          , a = t.custom || {};
                        return isNaN(a.borderWidth) ? !isNaN(i.pointBorderWidth) || r.isArray(i.pointBorderWidth) ? n = r.valueAtIndexOrDefault(i.pointBorderWidth, e, n) : isNaN(i.borderWidth) || (n = i.borderWidth) : n = a.borderWidth,
                        n
                    },
                    getPointRotation: function(t, e) {
                        var n = this.chart.options.elements.point.rotation
                          , i = this.getDataset()
                          , a = t.custom || {};
                        return isNaN(a.rotation) ? isNaN(i.pointRotation) && !r.isArray(i.pointRotation) || (n = r.valueAtIndexOrDefault(i.pointRotation, e, n)) : n = a.rotation,
                        n
                    },
                    updateElement: function(t, e, n) {
                        var i, a, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), c = o.index, d = u.data[e], h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), p = o.chart.options.elements.point;
                    ...
                    calculatePointY: function(t, e, n) {
                        var i, a, r, o = this.chart, s = this.getMeta(), l = this.getScaleForId(s.yAxisID), u = 0, c = 0;
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        "monotone" === a.dataset._model.cubicInterpolationMode)
                            ...
                            e = s.length; t < e; ++t)
                                n = s[t]._model,
                                i = r.splineCurve(r.previousItem(s, t)._model, n, r.nextItem(s, t)._model, a.dataset._model.tension),
                    ...
                    draw: function() {
                        var t, n = this.chart, i = this.getMeta(), a = i.data || [], o = n.chartArea, s = a.length, l = 0;
                        for (e(this.getDataset(), n.options) && (t = (i.dataset._model.borderWidth || 0) / 2,
                        ...
                        i.dataset.draw(),
                        r.canvas.unclipArea(n.ctx)); l < s; ++l)
                            a[l].draw(o)
                    },
                    setHoverStyle: function(t) {
                        ...
                        a.backgroundColor = i.hoverBackgroundColor || r.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, r.getHoverColor(a.backgroundColor)),
                        a.borderColor = i.hoverBorderColor || r.valueAtIndexOrDefault(e.pointHoverBorderColor, n, r.getHoverColor(a.borderColor)),
                        a.borderWidth = i.hoverBorderWidth || r.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth),
        ...
        19: [function(t, e, n) {
            ...
            e.exports = function(t) {
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    linkScales: r.noop,
                    update: function(t) {
                        var e, n, i, a = this, o = a.getDataset(), s = a.getMeta(), l = a.chart.options.startAngle || 0, u = a._starts = [], c = a._angles = [];
                        for (a._updateRadius(),
                        s.count = a.countVisibleElements(),
                        e = 0,
                        n = o.data.length; e < n; e++)
                            u[e] = l,
                            i = a._computeAngle(e),
                            c[e] = i,
                            l += i;
                    ...
                    updateElement: function(t, e, n) {
                        ...
                        var b = this.chart.options.elements.arc
                          ...
                          , x = r.valueAtIndexOrDefault
                          , w = t._model;
                        w.backgroundColor = y.backgroundColor ? y.backgroundColor : x(o.backgroundColor, e, b.backgroundColor),
                        w.borderColor = y.borderColor ? y.borderColor : x(o.borderColor, e, b.borderColor),
                        w.borderWidth = y.borderWidth ? y.borderWidth : x(o.borderWidth, e, b.borderWidth),
                        t.pivot()
                    },
            ...
            e.exports = function(t) {
                t.controllers.radar = t.DatasetController.extend({
                    ...
                    setHoverStyle: function(t) {
                        ...
                        a.radius = n.hoverRadius ? n.hoverRadius : r.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius),
                        a.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : r.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, r.getHoverColor(a.backgroundColor)),
                        a.borderColor = n.hoverBorderColor ? n.hoverBorderColor : r.valueAtIndexOrDefault(e.pointHoverBorderColor, i, r.getHoverColor(a.borderColor)),
                        a.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : r.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth)
                    }
                })
            }
        }
            ...
            e.exports = {
                ...
                advance: function(t) {
                    for (var e, n, i = this.animations, r = 0; r < i.length; )
                        ...
                        e.currentStep >= e.numSteps ? (a.callback(e.onAnimationComplete, [e], n),
                        n.animating = !1,
                        i.splice(r, 1)) : ++r
                }
            }
            ...
            e.exports = function(t) {
                ...
                o.extend(t.prototype, {
                    ...
                    resize: function(t) {
                        ...
                        if ((e.width !== r || e.height !== s) && (i.width = e.width = r,
                        i.height = e.height = s,
                        i.style.width = r + "px",
                        i.style.height = s + "px",
                    ...
                    buildOrUpdateScales: function() {
                        ...
                        o.each(a, function(n) {
                            ...
                            e(a.position) !== e(n.dposition) && (a.position = n.dposition),
                            r[s] = !0;
                            var u = null;
                    ...
                    update: function(e) {
                        ...
                        i = o.configMerge(t.defaults.global, t.defaults[n.config.type], i),
                    ...
                    updateLayout: function() {
                        !1 !== c.notify(this, "beforeLayout") && (l.update(this, this.width, this.height),
                    ...
                    updateDataset: function(t) {
                        ...
                        !1 !== c.notify(this, "beforeDatasetUpdate", [n]) && (e.controller.update(),
                    ...
                    draw: function(t) {
                        ...
                        e.transition(t),
                        e.width <= 0 || e.height <= 0 || !1 !== c.notify(e, "beforeDraw", [t]) && (o.each(e.boxes, function(t) {
                            t.draw(e.chartArea)
                        }, e),
                    ...
                    drawDataset: function(t, e) {
                        ...
                        !1 !== c.notify(this, "beforeDatasetDraw", [i]) && (n.controller.draw(e),
                    ...
                    _drawTooltip: function(t) {
                        ...
                        !1 !== c.notify(this, "beforeTooltipDraw", [n]) && (e.draw(),
                        c.notify(this, "afterTooltipDraw", [n]))
                    },
                    ...
                    handleEvent: function(t) {
                        ...
                        o.callback(i.onHover || i.hover.onHover, [t.native, n.active], n),
            ...
            e.exports = function() {
                        ...
                        merger: function(t, e, n, i) {
                            if ("xAxes" === t || "yAxes" === t) {
                                ...
                                a = 0; a < u; ++a)
                                    ...
                                    !e[t][a].type || l.type && l.type !== e[t][a].type ? r.merge(e[t][a], [o.getScaleDefaults(s), l]) : r.merge(e[t][a], l)
                            } else
                                r._merger(t, e, n, i)
                        }
                    })
                ...
                r.splineCurveMonotone = function(t) {
                    ...
                    for (e = 0; e < h - 1; ++e)
                        i = d[e],
                        a = d[e + 1],
                        i.model.skip || a.model.skip || (r.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = a.mK = 0 : (o = i.mK / i.deltaK,
                        s = a.mK / i.deltaK,
                    ...
                    for (e = 0; e < h; ++e)
                        ...
                        a && !a.model.skip && (c = (a.model.x - i.model.x) / 3,
                ...
                r.getRelativePosition = function(t, e) {
                    var n, i, a = t.originalEvent || t, o = t.target || t.srcElement, s = o.getBoundingClientRect(), l = a.touches;
                ...
                update: function(t, e, n) {
                    if (t) {
                        ...
                        i.each(h.concat(f, p, g), function(t) {
                            ...
                            n ? (e = t.update(t.fullWidth ? v : k, w),
                ...
                descriptors: function(t) {
                    ...
                    return this._plugins.concat(o.plugins || []).forEach(function(t) {
                        if (-1 === n.indexOf(t)) {
                            var e = t.id
                              , o = s[e];
                            !1 !== o && (!0 === o && (o = a.clone(i.global.plugins[e])),
                            n.push(t),
                            r.push({
                                plugin: t,
                                options: o || {}
        ...
        33: [function(t, e, n) {
            ...
            e.exports = a.extend({
                ...
                fit: function() {
                    ...
                    if (e.width = f ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && l.drawTicks ? g : 0,
                    ...
                    if (a.display && h) {
                        ...
                        if (f) {
                            ...
                            0 !== t.labelRotation ? (t.paddingLeft = "bottom" === i.position ? k * S + 3 : k * y + 3,
                            t.paddingRight = "bottom" === i.position ? k * y + 3 : k * M + 3) : (t.paddingLeft = S / 2 + 3,
                ...
                _autoSkip: function(t) {
                    var e, n, i, a, o = this, s = o.isHorizontal(), l = o.options.ticks.minor, u = t.length, c = r.toRadians(o.labelRotation), d = Math.cos(c), h = o.longestLabelWidth * d, f = [];
                    ...
                    if (n.display) {
                        ...
                        if (r.each(m, function(i, a) {
                            if (!r.isNullOrUndef(i.label)) {
                                ...
                                a === e.zeroLineIndex && n.offset === h.offsetGridLines ? (u = h.zeroLineWidth,
                                c = h.zeroLineColor,
                                d = h.zeroLineBorderDash,
                                f = h.zeroLineBorderDashOffset) : (u = r.valueAtIndexOrDefault(h.lineWidth, a),
                                c = r.valueAtIndexOrDefault(h.color, a),
                                d = r.valueOrDefault(h.borderDash, o.borderDash),
                                ...
                                if (g) {
                                    var E = w + N;
                                    "bottom" === n.position ? (z = p ? "middle" : "top",
                                    V = p ? "right" : "center",
                                    L = e.top + E) : (z = p ? "middle" : "bottom",
                                    V = p ? "left" : "center",
                                    L = e.bottom - E);
                        ...
                        r.each(P, function(t) {
                            ...
                            a.beginPath(),
                            h.drawTicks && (a.moveTo(t.tx1, t.ty1),
                            a.lineTo(t.tx2, t.ty2)),
                            h.drawOnChartArea && (a.moveTo(t.x1, t.y1),
                            a.lineTo(t.x2, t.y2)),
                            a.stroke(),
                            a.restore()),
                            s.display) {
                                ...
                                var n = t.label;
                                if (r.isArray(n))
                                    for (var i = n.length, o = 1.5 * b.size, l = e.isHorizontal() ? 0 : -o * (i - 1) / 2, u = 0; u < i; ++u)
                                        a.fillText("" + n[u], 0, l),
                                        l += o;
                                else
                                    a.fillText(n, 0, 0);
                        ...
                        f.display) {
                            ...
                            if (g)
                                ...
                                O = "bottom" === n.position ? e.bottom - R - S.bottom : e.top + R + S.top;
                            else {
                        ...
                        if (h.drawBorder) {
                            ...
                            g ? (E = W = "top" === n.position ? e.bottom : e.top,
                            E += B,
                            W += B) : (z = N = "left" === n.position ? e.right : e.left,
                            z += B,
                            N += B),
                            a.beginPath(),
                            a.moveTo(z, E),
        ...
        36: [function(t, e, n) {
            ...
            (e.exports = a.extend({
                ...
                update: function(t) {
                    var e, n, i, a, s, l, u, d = this, h = d._options, f = d._model, p = d._model = c(h), g = d._active, m = d._data, v = {
                        xAlign: f.xAlign,
                        yAlign: f.yAlign
                    }, b = {
                        x: f.x,
                    ...
                    if (g.length) {
                        ...
                        y = function(t, e) {
                            ...
                            return n.font = r.fontString(c, e._titleFontStyle, e._titleFontFamily),
                            r.each(e.title, p),
                        ...
                        b = function(t, e, n, i) {
                            ...
                            "center" === c ? "left" === u ? a += d : "right" === u && (a -= d) : "left" === u ? a -= h : "right" === u && (a += h),
                            {
                                x: a,
                                y: r
                            }
                        }(p, y, v = function(t, e) {
                            var n, i, a, r, o, s = t._model, l = t._chart, u = t._chart.chartArea, c = "center", d = "center";
                ...
                getCaretPosition: function(t, e, n) {
                    var i, a, r, o, s, l, u = n.caretSize, c = n.cornerRadius, d = n.xAlign, h = n.yAlign, f = t.x, p = t.y, g = e.width, m = e.height;
                    if ("center" === h)
                        s = p + m / 2,
                        "left" === d ? (a = (i = f) - u,
                        r = i,
                        ...
                        o = s - u,
                        l = s + u);
                    else if ("left" === d ? (i = (a = f + c + u) - u,
                    r = a + u) : "right" === d ? (i = (a = f + g - c - u) - u,
                ...
                drawTitle: function(t, e, n, i) {
                    ...
                    if (a.length) {
                        ...
                        for (n.fillStyle = s(e.titleFontColor, i),
                ...
                drawBody: function(t, e, n, i) {
                    ...
                    n.textBaseline = "top",
                    n.font = r.fontString(a, e._bodyFontStyle, e._bodyFontFamily);
                    var u = 0
                      , c = function(e) {
                        n.fillText(e, t.x + u, t.y),
                        t.y += a + o
                    };
                    n.fillStyle = s(e.bodyFontColor, i),
                    r.each(e.beforeBody, c);
                ...
                drawFooter: function(t, e, n, i) {
                    var a = e.footer;
                    a.length && (t.y += e.footerMarginTop,
                    n.textAlign = e._footerAlign,
                    n.textBaseline = "top",
                    n.fillStyle = s(e.footerFontColor, i),
                    n.font = r.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily),
                    r.each(a, function(i) {
        ...
        38: [function(t, e, n) {
            ...
            e.exports = a.extend({
                draw: function() {
                    var t, e, n, i, a = this._view, s = this._chart.ctx, l = a.spanGaps, u = this._children.slice(), c = o.elements.line, d = -1;
                    for (this._loop && u.length && u.push(u[0]),
                    s.save(),
                    s.lineCap = a.borderCapStyle || c.borderCapStyle,
                    s.setLineDash && s.setLineDash(a.borderDash || c.borderDash),
            ...
            e.exports = a.extend({
                ...
                draw: function(t) {
                    var e = this._view
                      ...
                      , c = e.x
                      , d = e.y;
                    e.skip || (void 0 === t || n.x >= t.left && 1.01 * t.right >= n.x && n.y >= t.top && 1.01 * t.bottom >= n.y) && (a.strokeStyle = e.borderColor || o,
                    a.lineWidth = r.valueOrDefault(e.borderWidth, i.global.elements.point.borderWidth),
        ...
        48: [function(t, e, n) {
            ...
            e.exports = {
                ...
                initialize: function() {
                    ...
                    e = "@-webkit-keyframes " + s + "{" + i + "}@keyframes " + s + "{" + i + "}." + o + "{-webkit-animation:" + s + " 0.001s;animation:" + s + " 0.001s;}",
        ...
        51: [function(t, e, n) {
            ...
            e.exports = {
                ...
                afterDatasetsUpdate: function(t, e) {
                    ...
                    for (i = 0; i < d; ++i)
                        o = null,
                        (r = (n = t.getDatasetMeta(i)).dataset) && r._model && r instanceof a.Line && (o = {
                    ...
                    if (n) {
                        ...
                        function(t, e, n, i, a, r) {
                            ...
                            s = g + !!r; o < s; ++o)
                                ...
                                p = d(c),
                                f && p ? (y = v.push(u),
                                x = b.push(c)) : y && x && (m ? (f && v.push(u),
                                p && b.push(c)) : (h(t, v, b, y, x),
                                y = x = 0,
                                v = [],
                                b = []));
                            h(t, v, b, y, x),
        ...
        52: [function(t, e, n) {
            ...
            var u = a.extend({
                    ...
                    a)
                        ...
                        m) {
                            ...
                            r.each(t.legendItems, function(e, i) {
                                ...
                                v[v.length - 1] + a + n.padding >= t.width && (b += c + n.padding,
                                v[v.length] = t.left),
                                p[i] = {
                                    left: 0,
                                    top: 0,
                ...
                draw: function() {
                    var t = this
                      ...
                      , u = t.lineWidths;
                    if (e.display) {
                        var c, d = t.ctx, h = r.valueOrDefault, f = h(n.fontColor, a.defaultFontColor), p = h(n.fontSize, a.defaultFontSize), g = h(n.fontStyle, a.defaultFontStyle), m = h(n.fontFamily, a.defaultFontFamily), v = r.fontString(p, g, m);
                        d.textAlign = "left",
                        ...
                        r.each(t.legendItems, function(i, l) {
                            ...
                            x ? m + g >= s && (v = c.y += w,
                            c.line++,
                            m = c.x = t.left + (s - u[c.line]) / 2) : v + w > t.bottom && (m = c.x = m + t.columnWidths[c.line] + n.padding,
                            ...
                            function(t, n, i) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    d.lineDashOffset = h(i.lineDashOffset, o.borderDashOffset),
                                    ...
                                    if (d.setLineDash && d.setLineDash(h(i.lineDash, o.borderDash)),
            ...
            e.exports = {
                ...
                beforeUpdate: function(t) {
                    var e = t.options.legend
                      , n = t.legend;
                    e ? (r.mergeIf(e, i.global.legend),
                    n ? (o.configure(t, n, e),
                    n.options = e) : c(t, e)) : n && (o.removeBox(t, n),
                    delete t.legend)
                },
        ...
        53: [function(t, e, n) {
            ...
            var l = a.extend({
                ...
                draw: function() {
                    var t = this
                      ...
                      , o = i.global;
                    if (a.display) {
                        var s, l, u, c = n(a.fontSize, o.defaultFontSize), d = n(a.fontStyle, o.defaultFontStyle), h = n(a.fontFamily, o.defaultFontFamily), f = r.fontString(c, d, h), p = r.options.toLineHeight(a.lineHeight, c), g = p / 2 + a.padding, m = 0, v = t.top, b = t.left, y = t.bottom, x = t.right;
            ...
            e.exports = {
                ...
                beforeUpdate: function(t) {
                    var e = t.options.title
                      , n = t.titleBlock;
                    e ? (r.mergeIf(e, i.global.title),
                    n ? (o.configure(t, n, e),
                    n.options = e) : u(t, e)) : n && (o.removeBox(t, n),
                    delete t.titleBlock)
                }
            }
        }
                        ...
                        e.stacked || s) {
                            ...
                            a.each(i, function(i, r) {
                                ...
                                n.isDatasetVisible(r) && o(s) && a.each(i.data, function(n, i) {
                                    ...
                                    isNaN(a) || s.data[i].hidden || (c[i] = c[i] || 0,
                                    d[i] = d[i] || 0,
                                    e.relativePoints ? c[i] = 100 : a < 0 ? d[i] += a : c[i] += a)
                                })
                            }),
                            a.each(l, function(e) {
                            ...
                            a.each(i, function(e, i) {
                                ...
                                n.isDatasetVisible(i) && o(r) && a.each(e.data, function(e, n) {
                                    ...
                                    isNaN(i) || r.data[n].hidden || (null === t.min ? t.min = i : i < t.min && (t.min = i),
                        ...
                        var t = this
                          ...
                          , r = t.ticks = function(t, e) {
                            ...
                            if (t.stepSize && t.stepSize > 0)
                                ...
                                void 0 !== (a = t.precision) && (n = Math.pow(10, a),
                                r = Math.ceil(r * n) / n)
                            }
                            var l = Math.floor(e.min / r) * r
                              , u = Math.ceil(e.max / r) * r;
                            i.isNullOrUndef(t.min) || i.isNullOrUndef(t.max) || !t.stepSize || i.almostWhole((t.max - t.min) / t.stepSize, r / 1e3) && (l = t.min,
                            u = t.max);
                            var c = (u - l) / r;
                            c = i.almostEquals(c, Math.round(c), r / 1e3) ? Math.round(c) : Math.ceil(c),
                            a = 1,
                            r < 1 && (a = Math.pow(10, 1 - Math.floor(i.log10(r))),
                            l = Math.round(l * a) / a,
                            u = Math.round(u * a) / a),
                            o.push(void 0 !== t.min ? t.min : l);
                            for (var d = 1; d < c; ++d)
                                o.push(Math.round((l + d * r) * a) / a);
                            return o.push(void 0 !== t.max ? t.max : u),
                            o
                        }(a, t);
                ...
                var e = {
                  ...
                  , n = a.extend({
                    determineDataLimits: function() {
                        ...
                        e.stacked || s) {
                            ...
                            i.each(a, function(a, r) {
                                var s = n.getDatasetMeta(r)
                                  , u = [s.type, void 0 === e.stacked && void 0 === s.stack ? r : "", s.stack].join(".");
                                n.isDatasetVisible(r) && o(s) && (void 0 === l[u] && (l[u] = []),
                                i.each(a.data, function(e, n) {
                                    var i = l[u]
                                      , a = +t.getRightValue(e);
                                    isNaN(a) || s.data[n].hidden || a < 0 || (i[n] = i[n] || 0,
                                    i[n] += a)
                                }))
                            }),
                            i.each(l, function(e) {
                            ...
                            i.each(a, function(e, a) {
                                ...
                                n.isDatasetVisible(a) && o(r) && i.each(e.data, function(e, n) {
                                    var i = +t.getRightValue(e);
                                    isNaN(i) || r.data[n].hidden || i < 0 || (null === t.min ? t.min = i : i < t.min && (t.min = i),
                                    null === t.max ? t.max = i : i > t.max && (t.max = i),
                    ...
                    handleTickRangeOptions: function() {
                        ...
                        t.min = n(e.min, t.min),
                        t.max = n(e.max, t.max),
                        t.min === t.max && (0 !== t.min && null !== t.min ? (t.min = Math.pow(10, Math.floor(i.log10(t.min)) - 1),
                        t.max = Math.pow(10, Math.floor(i.log10(t.max)) + 1)) : (t.min = 1,
                        t.max = 10)),
                        ...
                        null === t.minNotZero && (t.min > 0 ? t.minNotZero = t.min : t.max < 1 ? t.minNotZero = Math.pow(10, Math.floor(i.log10(t.max))) : t.minNotZero = 1)
                    },
                    buildTicks: function() {
                        var t = this
                          , e = t.options.ticks
                          ...
                          , r = t.ticks = function(t, e) {
                            ...
                            0 === s ? (n = Math.floor(i.log10(e.minNotZero)),
                            a = Math.floor(e.minNotZero / Math.pow(10, n)),
                            r.push(s),
                            s = a * Math.pow(10, n)) : (n = Math.floor(i.log10(s)),
                    ...
                    getPixelForValue: function(e) {
                        var n, a, r, o, s, l = this, u = l.options.ticks.reverse, c = i.log10, d = l._getFirstTickValue(l.minNotZero), h = 0;
                        ...
                        a = u ? l.right : l.left) : (n = l.height,
                        s *= -1,
                        a = u ? l.top : l.bottom),
                        e !== r && (0 === r && (n -= h = i.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize),
                        r = d),
                    ...
                    getValueForPixel: function(e) {
                        var n, a, r, o, s = this, l = s.options.ticks.reverse, u = i.log10, c = s._getFirstTickValue(s.minNotZero);
                        if (l ? (a = s.end,
                        r = s.start) : (a = s.start,
                        r = s.end),
                        s.isHorizontal() ? (n = s.width,
                        o = l ? s.right - e : e - s.left) : (n = s.height,
                ...
                var p = t.LinearScaleBase.extend({
                        ...
                        a.each(e.data.datasets, function(r, o) {
                            if (e.isDatasetVisible(o)) {
                                ...
                                a.each(r.data, function(e, a) {
                                    ...
                                    isNaN(r) || s.data[a].hidden || (n = Math.min(r, n),
                                    i = Math.max(r, i))
                                })
                            }
                        }),
                    ...
                    fit: function() {
                        ...
                        this.options.pointLabels.display ? function(t) {
                            var e, n, i, r = l(t), o = Math.min(t.height / 2, t.width / 2), c = {
                                r: t.width,
                                l: 0,
                                t: t.height,
                                b: 0
                            ...
                            for (e = 0; e < g; e++) {
                                ...
                                b.start < c.l && (c.l = b.start,
                                d.l = m),
                                b.end > c.r && (c.r = b.end,
                                d.r = m),
                                y.start < c.t && (c.t = y.start,
                                d.t = m),
                                y.end > c.b && (c.b = y.end,
                                d.b = m)
                            }
                            ...
                            a.each(t.ticks, function(n, l) {
                                if (l > 0 || r.reverse) {
                                    ...
                                    if (i.display && 0 !== l && function(t, e, n, i) {
                                        var r = t.ctx;
                                        if (r.strokeStyle = a.valueAtIndexOrDefault(e.color, i - 1),
                                        r.lineWidth = a.valueAtIndexOrDefault(e.lineWidth, i - 1),
                                    ...
                                    r.display) {
                                        ...
                                        r.showLabelBackdrop) {
                                            ...
                                            u.fillRect(-h / 2 - r.backdropPaddingX, -c - p / 2 - r.backdropPaddingY, h + 2 * r.backdropPaddingX, p + 2 * r.backdropPaddingY)
                                        }
                                        u.textAlign = "center",
        ...
        59: [function(t, e, n) {
            ...
            function g(t, e) {
                var n = e.parser
                  , a = e.parser || e.format;
                return "function" == typeof n ? n(t) : "string" == typeof t && "string" == typeof a ? i(t, a) : (t instanceof i || (t = i(t)),
            ...
            function b(t, e, n, a) {
                var o, s = a.time, l = s.unit || function(t, e, n, i) {
                    ...
                    for (a = d.indexOf(t); a < s - 1; ++a)
                        if (o = (r = c[d[a]]).steps ? r.steps[r.steps.length - 1] : u,
                        r.common && Math.ceil((n - e) / (o * r.size)) <= i)
                            return d[a];
                    return d[s - 1]
                }(s.minUnit, t, e, n), h = v(l), f = r.valueOrDefault(s.stepSize, s.unitStepSize), p = "week" === l && s.isoWeekday, g = a.ticks.major.enabled, m = c[l], b = i(t), y = i(e), x = [];
                ...
                o = i(b),
                g && h && !p && !s.round && (o.startOf(h),
                o.add(~~((b - o) / (m.size * f)) * f, l)); o < y; o.add(f, l))
                    x.push(+o);
                return x.push(+o),
                x
            }
            e.exports = function() {
                var t = o.extend({
                    ...
                    determineDataLimits: function() {
                        var t, e, n, a, o, s, c = this, d = c.chart, p = c.options.time, g = p.unit || "day", v = u, b = l, y = [], x = [], w = [];
                        for (t = 0,
                        ...
                        n = (d.data.datasets || []).length; t < n; ++t)
                            if (d.isDatasetVisible(t))
                                ...
                                x[t] = [];
                        w.length && (w = f(w).sort(h),
                        v = Math.min(v, w[0]),
                        b = Math.max(b, w[w.length - 1])),
                        y.length && (y = f(y).sort(h),
                        v = Math.min(v, y[0]),
                    ...
                    buildTicks: function() {
                        ...
                        for ("ticks" === s.bounds && u.length && (r = u[0],
                        o = u[u.length - 1]),
                        r = m(l.min, a) || r,
                        o = m(l.max, a) || o,
                        t = 0,
                        ...
                        a._offsets = function(t, e, n, i, a) {
                            var r, o, s = 0, l = 0;
                            return a.offset && e.length && (a.time.min || (r = e.length > 1 ? e[1] : i,
                            o = e[0],
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        i.tooltipFormat ? g(a, i).format(i.tooltipFormat) : "string" == typeof a ? a : g(a, i).format(this._labelFormat)
                    },
        ...
        return {
            init: function() {
                ...
                t(".wow").each(function() {
                    ...
                    i ? (i = t(this).attr("data-wow-delay").slice(0, -1),
                    parseFloat(i),
                    t(this).addClass("animated"),
                    t(this).css({
                        visibility: "visible"
...
function(t, e) {
    ...
    var l = {
        ...
        hide: function(t, e) {
            for (var n = (e = e || this).getElementsByClassName("waves-rippling"), a = 0, r = n.length; a < r; a++)
                c(t, e, n[a]);
            i && (e.removeEventListener("touchend", l.hide),
    ...
    function h(t) {
        ...
        if (null !== e) {
            ...
            "touchstart" === t.type && l.delay) {
                ...
                l.show(t, e),
                i && (e.addEventListener("touchend", l.hide, !1),
    ...
    return t.init = function(t) {
        ...
        i && (e.addEventListener("touchstart", h, !1),
...
!function(t) {
    ...
    t(document).on("blur", i, function(e) {
        ...
        i && a && o && n.siblings("label, i").removeClass("active"),
        r(n)
    }),
...
function(t) {
    t.fn.mdbTreeview = function() {
        ...
        if (e.hasClass("treeview-animated")) {
            ...
            i.on("click", function() {
                var e = t(this);
                e.hasClass("opened") ? e.removeClass("opened") : (i.removeClass("opened"),
                e.addClass("opened"))
            })
        }
        if (e.hasClass("treeview-colorful")) {
            ...
            r.on("click", function() {
                var e = t(this);
                e.hasClass("opened") ? r.removeClass("opened") : (r.removeClass("opened"),
                e.addClass("opened"))
            })
        }
    }
